      ...
      <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
        <div className="text-center space-y-10 max-w-4xl px-6">
          <h1 className="text-8xl md:text-9xl font-bold animate-fade-in-up animation-delay-200">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-purple-600">SAT AI</span>
          </h1>
          
          <div className="flex justify-center animation-delay-600 animate-fade-in">
            <Button className="group pointer-events-auto animate-pulse bg-gradient-to-r from-orange-500 to-purple-600 hover:opacity-90 transition-opacity px-8 py-6 text-lg">
              Explore
